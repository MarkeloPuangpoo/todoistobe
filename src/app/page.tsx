...
export default function Home() {
  ...
  return (
    <main className="flex h-screen w-full flex-col bg-slate-50 dark:bg-zinc-950 overflow-hidden transition-colors">
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-6 dark:border-zinc-800 dark:bg-zinc-900 transition-colors z-50 relative">
